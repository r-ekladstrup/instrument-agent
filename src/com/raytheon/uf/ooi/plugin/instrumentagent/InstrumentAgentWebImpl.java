...
public class InstrumentAgentWebImpl implements IAgentWebInterface {
     ...
     * 
     * @see
     * com.raytheon.uf.ooi.plugin.instrumentagent.IAgentWebInterface#getAgent
     * (javax.ws.rs.container.AsyncResponse, java.lang.String, double)
     * 
     * If blocking == false, fetch and return the current state otherwise, do
     * not return until the overall state has changed.
     * 
                ...
                executor.execute(new Runnable() {
                    ...
                    public void run() {
                        asyncResponse.resume(Response
                                .ok(thisAgent.getOverallStateChanged(), MediaType.APPLICATION_JSON).build());
                    }
                });
            }
        } else {
